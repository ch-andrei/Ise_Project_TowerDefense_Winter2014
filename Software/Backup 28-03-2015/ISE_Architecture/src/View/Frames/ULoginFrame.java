...
public class ULoginFrame extends JFrame {
	...
	public ULoginFrame() {
		...
		int frameMiddle = width / 2;
		int newGameButtonX = frameMiddle
				- (menuNewGameComponent.getWidth() / 2) + 20;
		int loadGameButtonX = frameMiddle
				- (menuLoadGameComponent.getWidth() / 2);
		int highscoresButtonX = frameMiddle
				- (menuHighscoreComponent.getWidth() / 2);

		menuBackgroundComponent.setLocation(0, 0);
		menuNewGameComponent.setLocation(200, 200);
		menuLoadGameComponent.setLocation(200, 300);
		menuHighscoreComponent.setLocation(200, 400);
