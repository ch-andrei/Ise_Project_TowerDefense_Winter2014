...
/**
 * Class containing a type of tower (magic tower)
 * 
 * @author YN
 */
public class UTowerMagicComponent extends UTowerComponent {
	Image img = Toolkit.getDefaultToolkit().getImage(
			getClass().getClassLoader().getResource("images/magicTower.png"));
	 ...
	 */
	public UTowerMagicComponent(int tileSize) {
		super("Sticky Tower", 3, 5, (5 * tileSize), 0.5, 2, 5);
