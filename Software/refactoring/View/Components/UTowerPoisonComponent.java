...
/**
 * Class containing a type of tower (poison tower)
 * 
 * @author YN
 */
public class UTowerPoisonComponent extends UTowerComponent {
	Image img = Toolkit.getDefaultToolkit().getImage(
			getClass().getClassLoader().getResource("images/poisonTower.png"));
	 ...
	 */
	public UTowerPoisonComponent(int tileSize) {
		super("Poison Infecter", 3, 5, (4 * tileSize), 0.5, 2, 5);
	...
	public String getUpgradeSpecs() {
		...
		double upgradeDamage = getDamage() + 3;
