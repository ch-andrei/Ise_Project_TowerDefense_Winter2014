...
/**
 * Class containing a type of tower (water tower)
 * 
 * @author YN
 */
public class UTowerWaterComponent extends UTowerComponent {
	Image img = Toolkit.getDefaultToolkit().getImage(
			getClass().getClassLoader().getResource("images/waterTower.png"));
	 ...
	 */
	public UTowerWaterComponent(int tileSize) {
		super("Water Nymph", 2, 5, (5 * tileSize), 0.25, 2, 5);
